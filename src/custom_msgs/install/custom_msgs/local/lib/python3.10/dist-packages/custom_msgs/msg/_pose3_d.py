...
class Metaclass_Pose3D(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from custom_msgs.msg import Quaternion
...
class Pose3D(metaclass=Metaclass_Pose3D):
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BasicType('float'),  # noqa: E501
        rosidl_parser.definition.BasicType('float'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['custom_msgs', 'msg'], 'Quaternion'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from custom_msgs.msg import Quaternion
        self.w = kwargs.get('w', Quaternion())
    ...
    def w(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'w' field must be a sub message of type 'Quaternion'"
        self._w = value
