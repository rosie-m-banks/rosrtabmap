...
bool custom_msgs__msg__pose3_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_msgs.msg._pose3_d.Pose3D", full_classname_dest, 31) == 0);
  }
  custom_msgs__msg__Pose3D * ros_message = _ros_message;
  {  // x
  ...
  {  // w
    ...
    if (!custom_msgs__msg__quaternion__convert_from_py(field, &ros_message->w)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * custom_msgs__msg__pose3_d__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msgs.msg._pose3_d");
  ...
  {  // w
    PyObject * field = NULL;
    field = custom_msgs__msg__quaternion__convert_to_py(&ros_message->w);
    if (!field) {
      return NULL;
    }
    {
