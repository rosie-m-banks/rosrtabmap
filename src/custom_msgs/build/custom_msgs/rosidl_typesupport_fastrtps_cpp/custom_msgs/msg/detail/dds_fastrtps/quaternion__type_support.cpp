...
#include "custom_msgs/msg/detail/quaternion__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_msgs::msg::Quaternion & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msgs::msg::Quaternion & ros_message)
{
  // Member: w
  cdr >> ros_message.w;
...
{
  auto typed_message =
    static_cast<const custom_msgs::msg::Quaternion *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msgs::msg::Quaternion *>(
    untyped_ros_message);
...
{
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_Quaternion__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs, msg, Quaternion)() {
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_Quaternion__handle;
}
